...
export default function Demo() {
  ...
  // Using separate refs for each textarea
  ...
  const processWithAPI = async (action) => {
    ...
    try {
      // Get the current active textarea value based on the action type
      let currentValue = "";

      // Use the appropriate ref based on the action type instead of activeTab
      if (action === "generate") {
...
// while maintaining the same functionality and following best practices.`;
  ...
  // Component for handling code snippet generation
  ...
  // Component for code explanation
  const CodeExplainer = () => (
    <div className="space-y-4">
      <div className="flex items-center space-x-2">
  ...
  // Get the icon and text for the empty state based on active tab
    ...
    switch (activeTab) {
      case "snippetGenerator":
        return {
          ...
          description:
            "Enter a description to generate code snippets in your selected language",
        };
      case "bugFixer":
        return {
          icon: <FileX size={48} className="text-[#EEEEEE] opacity-70" />,
          title: "Fix Code Bugs",
          description: "Paste your buggy code to get fixes and explanations",
        };
      case "codeExplainer":
        return {
          ...
          description:
            "Paste any code to get a detailed explanation of how it works",
        };
      case "codeConverter":
        return {
          icon: (
          ...
          description:
            "Convert your code from one language to another with a click",
        };
      default:
        return {
          icon: <Code size={48} className="text-[#EEEEEE] opacity-70" />,
  ...
  return (
    <section className="py-6 px-4 overflow-hidden bg-[#222831]">
